  ...
  return (
    <div className='flex flex-col items-center gap-[40px] leftPart text-white my-[30px]'>
                ...
                <div className='border firstInfo border-[#283141] w-[800px] py-[25px] px-[20px] rounded-[12px] flex flex-col gap-[25px]'>
                    ...
                    {/* Features */}
                    <div className='font-semibold text-2xl'>Your Flat has been Booked!</div>
                   ...
                   <div className='flex items-center w-[100%]'>
                    ...
                    <div onClick={goToRealEstate} className='text-base bg-[#4f46e5] w-fit font-semibold p-[10px] px-[30px] hover:cursor-pointer rounded-full'>Explore More Stays</div>
                </div>
